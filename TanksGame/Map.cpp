...
Map::Map(int gridSize) : gridSize(gridSize), map(createMap()) {}

void Map::printMatrix(const std::shared_ptr<std::vector<std::vector<MazeCell>>>& matrix) {
    std::system("cls");
...
std::vector<std::pair<int, int>> Map::nearestCells(std::shared_ptr<std::pair<int, int>> cell) {
...
// todo: simplify
std::shared_ptr<std::vector<std::vector<MazeCell>>> Map::createMap() {
...
std::pair<int, int> Map::startingPoint(std::shared_ptr<std::vector<std::vector<MazeCell>>> map) {
...
std::pair<int, int> Map::getRandomPair(std::shared_ptr<std::vector<std::vector<MazeCell>>> map,
...
bool Map::closeToDestination(std::shared_ptr<std::vector<std::vector<MazeCell>>> map, std::pair<int, int> toCheck) {
...
std::shared_ptr<std::vector<std::pair<int, int>>> Map::getNeighbours(std::shared_ptr<std::vector<std::vector<MazeCell>>> map, std::shared_ptr<std::pair<int, int>> currentSpot) {
    ...
    for (auto& coordinates : nearestCells(currentSpot))
    {
        if ((insideTheGameField(map, coordinates) && (*map)[coordinates.first][coordinates.second] == Destination)) {
...
bool Map::nonPathNeighbours(std::shared_ptr<std::vector<std::vector<MazeCell>>> map, std::pair<int, int> toCheck) {

    for (auto& neighbour : nearestCells(std::make_shared<std::pair<int, int>>(toCheck)))
    {
...
bool Map::insideTheGameField(std::shared_ptr<std::vector<std::vector<MazeCell>>> map, std::pair<int, int> toCheck) {
